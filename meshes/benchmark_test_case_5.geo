...
Point(11) = {0.5, 0.5, 1, 1.0};
Point(12) = {0.5, 0, 0.5, 1.0};
Point(13) = {0.5, 1, 0.5, 1.0};
Point(14) = {0, 0.5, 0.5, 1.0};
Point(15) = {1, 0.5, 0.5, 1.0};
Point(10) = {0.5, 0.5, 0.5, 1.0};
Point(16) = {1, 0, 0.5, 1.0};
Point(17) = {1, 1, 0.5, 1.0};
Point(18) = {0, 1, 0.5, 1.0};
Point(19) = {0, 0, 0.5, 1.0};
Point(20) = {0, 0.5, 0, 1.0};
Point(21) = {0, 0.5, 1, 1.0};
Point(22) = {1, 0.5, 1, 1.0};
Point(23) = {0, 0.5, 1, 1.0};
Point(24) = {1, 0.5, 0, 1.0};
Point(25) = {0.5, 0, 0, 1.0};
Point(26) = {0.5, 0, 1, 1.0};
Point(27) = {0.5, 1, 1, 1.0};
Point(28) = {0.5, 1, 0, 1.0};
Line(13) = {21, 14};
Line(14) = {19, 14};
Line(15) = {14, 20};
Line(16) = {14, 18};
