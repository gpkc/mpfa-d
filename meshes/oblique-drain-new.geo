...
Physical Volume(2) = {2};
Physical Volume(3) = {3};
Transfinite Line {41, 7, 5, 43} = 1 Using Progression 1;
Transfinite Line {32, 54, 6, 3, 23, 50, 21, 42} = 25 Using Progression 1;
Transfinite Surface {59};
Transfinite Surface {60};
Transfinite Surface {14};
Transfinite Surface {14};
Transfinite Line {8, 18, 18, 2, 65} = 16 Using Progression 1;
Transfinite Line {10, 20, 4, 63} = 9 Using Progression 1;
Transfinite Line {9, 28, 28, 19, 24, 76, 64, 72, 1} = 25 Using Progression 1;
