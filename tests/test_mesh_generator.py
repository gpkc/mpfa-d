...
class MeshGeneratorTest(unittest.TestCase):
    ...
    def setUp(self):
        self.mesh_tetra00 = GenerateMesh('mesh_bench/meshB_tetra/RandMesh4.msh')
    ...
    def test_mesh_reading_tool(self):
        ...
        self.assertEqual(information_set, [10, 12, 18, 45, 90, 135])

    @unittest.skip('skip')
    def test_method_reads_values_properly(self):
        information_set = [10, 12, 18, 45, 90, 135]
        f = open('mesh_bench/meshB_tetra/tet.00.msh')
        lines = f.readlines()
    ...
    def test_if_mesh_works_in_mesh_preprocessor(self):
        ...
        self.mesh_tetra00.create_volumes()
        self.mesh_tetra00.create_dirichlet_boundary_conditions()
        self.mesh_tetra00.write_msh_file('rand_mesh_test.vtk')
